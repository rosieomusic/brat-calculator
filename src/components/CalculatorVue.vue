    ...
    data() {
        return {
            ...
            buttons: [
                ...
                {label: '-', value: '-', sound:'vue-project/public/sounds/bumpin-that-b.wav'},
                {label: '7', value: '7', sound:'vue-project/public/sounds/7.wav'},
                {label: '8', value: '8', sound:'vue-project/public/sounds/8.wav'},
                {label: '9', value: '9', sound:'vue-project/public/sounds/9.wav'},
                {label: '*', value: '*', sound:'vue-project/public/sounds/times.wav'},
                {label: '/', value: '/', sound:'vue-project/public/sounds/divide.wav'},
                {label: '0', value: '0', sound:'vue-project/public/sounds/0.wav'},
                {label: '.', value: '.', sound:'vue-project/public/sounds/clap-plus.wav'},
                {label: 'AC', value: 'all-clear', sound:'vue-project/public/sounds/ac-rewind.wav'},
                {label: '=', value: '=', sound:'vue-project/public/sounds/im-a-brat.wav'}   
            ],
        };
    },
    methods: {
